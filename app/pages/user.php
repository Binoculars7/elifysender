...
?>
        <!-- ADMIN TABLE -->
         <div class="card shadow mb-4">
          ...
          <tbody>
<?php                  
    $query = 'SELECT ID, FIRST_NAME,LAST_NAME,USERNAME,PRIVILEGE, t.TYPE
              FROM users u
                ...
                echo '<td>'. $row['PRIVILEGE'].'</td>';
                      echo '<td align="right"> <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                ...
                                <li>
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-block" style="border-radius: 0px; background:grey;" href="us_del.php?action=del & id='.$row['ID']. '">
