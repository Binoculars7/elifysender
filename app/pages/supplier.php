                ...
                echo '<td>'. $row['PHONE_NUMBER'].'</td>';
                      echo '<td align="right"> <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                ...
                                <li>
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-block" style="border-radius: 0px; background:grey; border:1px solid;" href="sup_del.php?action=delete & id='.$row['SUPPLIER_ID']. '">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="sup_transac.php?action=add">
              ...
              <div class="form-group">
                <select class="form-control" id="province" placeholder="State" name="province" required></select>
              </div>
              <div class="form-group">
                <select class="form-control" id="city" placeholder="LGA" name="city" required></select>
              </div>
              <div class="form-group">
