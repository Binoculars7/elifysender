                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">
                      ...
                      <a href="posq.php" style="color: #4e73df; padding:0.3em 1em; font-size: 17px; border-radius: 20px; text-decoration: none;"><b>Add Sale</b></a>
                        ...
                        <!-- /.panel-heading -->
                        <div class="card-body">
<h5 style="color:white; background: #4e73df; padding: 0.4em 0em 0.4em 0.4em;"><b>Add Sale</b></h5>
                  ...
                  <form method="post"> 
                    ...
                    <input type="text" name="em" required placeholder="Enter Email" style="width: 250px; height: 35px; font-weight: bold; padding: 1.3em 1em; margin: 0.4em 0em 0.3em 0em; border:none; background:#dfe1e9;"><br>
                    <input type="submit" name="submit" value="Add Customer" style="background:#4e73df; color: white; font-weight: bold; border:none; padding: 0.4em 1.2em; margin-top: 0.3em;">
                  </form>
                  <hr>
                  <br><br>
