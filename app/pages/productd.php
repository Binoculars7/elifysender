...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Product Description&nbsp;<!--<a  href="#" data-toggle="modal" data-target="#aModal" type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a>--></h4>
            </div>
            <div class="card-body">
...
<?php                  
    $query = 'SELECT PRODUCT_ID, PRODUCT_CODE, NAME, ON_HAND, PRICE, CNAME, DESCRIPTION, DATE_STOCK_IN FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID GROUP BY PRODUCT_CODE';
        $result = mysqli_query($db, $query) or die (mysqli_error($db));
