                    ...
                    <?php                  
                      ...
                      echo '<td align="right"> <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                ...
                                <li>
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-block" style="border-radius: 0px; border:1px solid; background:grey;" href="emp_del.php?action=delete & id='.$row['EMPLOYEE_ID']. '">
