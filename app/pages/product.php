...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Product Entry&nbsp;<a  href="#" data-toggle="modal" data-target="#aModal" type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
            <div class="card-body">
...
<?php                  
    $query = 'SELECT PRODUCT_ID, PRODUCT_CODE, NAME, ON_HAND, QTY_STOCK, PRICE, CNAME, DATE_STOCK_IN FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID GROUP BY PRODUCT_CODE';
        $result = mysqli_query($db, $query) or die (mysqli_error($db));
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- <div class="form-group">
           ...
           <div class="form-group">
             <input type="number"  min="1" max="9999999999" class="form-control" placeholder="Purchased Price" name="price" required>
           </div>

           <div class="form-group">
             <input type="number"  min="1" max="999999999" class="form-control" placeholder="Selling Price" name="onhand" required>
           </div>
