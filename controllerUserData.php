...
//Recipients
$mail->setFrom('elitechain.com@gmail.com', 'Moonpie');
...
$info = "We’ve sent a verification code to your email – $email. It might also be in your SPAM";
$_SESSION['info'] = $info;
...
$errors['db-error'] = "Failed while inserting data into database!";
    ...
    //if user click login buttonssssssss
    ...
    if(isset($_POST['check-email'])){
        ...
        if(mysqli_num_rows($run_sql) > 0){
            ...
            $info = "We've sent a password reset otp to your email – $email. It might also be in your SPAM";
            $_SESSION['info'] = $info;
            $_SESSION['email'] = $email;
            $_SESSION['password'] = $password;
